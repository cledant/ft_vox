...
typedef struct BlockTextureType
{
    ...
    glm::vec2 level_1_texture_coord_xy_plus;
    glm::vec2 level_1_texture_coord_xy_minus;
    glm::vec2 level_1_texture_coord_xz_plus;
    glm::vec2 level_1_texture_coord_xz_minus;
    glm::vec2 level_1_texture_coord_yz_plus;
    glm::vec2 level_1_texture_coord_yz_minus;
} BlockTextureType;
...
constexpr glm::vec2 TEX_NOT_USED = glm::vec2(0.0);
