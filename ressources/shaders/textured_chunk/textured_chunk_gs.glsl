...
#define FOLIAGE vec2(5 * TEX_STEP, 3 * TEX_STEP)
...
void main()
{
    switch (gs_in[0].block_type) {
        ...
        case 2:
        //TODO special fct
        generate_textured_block(gs_in[0].block_position, gs_in[0].block_faces, GRASS_SIDE, GRASS_SIDE, GRASS_SIDE, GRASS_SIDE, GRASS_SIDE, GRASS_SIDE, NO_COLOR_MOD);
        case 3:
